...
/* function calcularPrima () {
    if (cobertura == "1") {
        cotizacion = new Cotizacion(nombre.toUpperCase(), edad, localidad.toUpperCase(), marca.toUpperCase(), modelo.toUpperCase(), anio, valor, "A - Responsabilidad Civil", (valor*tarifaA));
        ...
        cotizacion = new Cotizacion(nombre.toUpperCase(), edad, localidad.toUpperCase(), marca.toUpperCase(), modelo.toUpperCase(), anio, valor, "C - Terceros Completo", (valor*tarifaC));
        console.log(cotizacion);
        alert("Sr/a " + cotizacion.nombre + ", Edad: " + cotizacion.edad + ", Localidad: " + cotizacion.zonaRiesgo + "\n\nEl costo del seguro para su " + cotizacion.marca + " " + cotizacion.modelo + " " + cotizacion.anio + " es. \n" + cotizacion.producto + ": $" + cotizacion.valor);
        registroDeCotiz.push(cotizacion);
        console.log(registroDeCotiz);
        ...
        cotizacion = new Cotizacion(nombre.toUpperCase(), edad, localidad.toUpperCase(), marca.toUpperCase(), modelo.toUpperCase(), anio, valor, "D - Todo riesgo", (valor*tarifaD));
        console.log(cotizacion);
        alert("Sr/a " + cotizacion.nombre + ", Edad: " + cotizacion.edad + ", Localidad: " + cotizacion.zonaRiesgo + "\n\nEl costo del seguro para su " + cotizacion.marca + " " + cotizacion.modelo + " " + cotizacion.anio + " es. \n" + cotizacion.producto + ": $" + cotizacion.valor);
        registroDeCotiz.push(cotizacion);
        console.log(registroDeCotiz);
